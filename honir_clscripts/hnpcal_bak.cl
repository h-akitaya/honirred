...
#    printf( "%d", apnum )
    ...
    if( hwppa == 0.0 && apnum == 1 )
      print( img, >> "_pcalql_o_000.lst" )
    else if( hwppa == 0.0 && apnum == 2 )
      print( img, >> "_pcalql_e_000.lst" )
    else if( hwppa == 22.5 && apnum == 1 )
      print( img, >> "_pcalql_o_225.lst" )
    else if( hwppa == 22.5 && apnum == 2 )
      print( img, >> "_pcalql_e_225.lst" )
    else if( hwppa == 45.0 && apnum == 1 )
      print( img, >> "_pcalql_o_450.lst" )
    else if( hwppa == 45.0 && apnum == 2 )
      print( img, >> "_pcalql_e_450.lst" )
    else if( hwppa == 67.5 && apnum == 1 )
      print( img, >> "_pcalql_o_675.lst" )
    else if( hwppa == 67.5 && apnum == 2 )
