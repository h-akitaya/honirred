...
file f_iadu = "pcalql_i_ave.fits"
file f_iadu_err = "pcalql_i_err.fits"
...
ap=1
while( fscan( list, \
              wl, dm, i, dm, dm, di, dm, dm, iadu, dm, dm, diadu,\
...
delete ( tmpf_slist ,ver- )

delete ( tmpf_i ,ver- )
delete ( tmpf_i_err ,ver- )
delete ( tmpf_iadu ,ver- )
delete ( tmpf_iadu_err ,ver- )
delete ( tmpf_q ,ver- )
delete ( tmpf_q_err ,ver- )
delete ( tmpf_u ,ver- )
delete ( tmpf_u_err ,ver- )
delete ( tmpf_p ,ver- )
delete ( tmpf_p_err ,ver- )
delete ( tmpf_t ,ver- )
delete ( tmpf_t_err ,ver- )
delete ( tmpf_pasted1 ,ver- )
delete ( tmpf_pasted2 ,ver- )
delete ( tmpf_pasted3 ,ver- )
