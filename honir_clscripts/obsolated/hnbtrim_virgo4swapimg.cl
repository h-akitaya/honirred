#
#  hnbtrim_virgo4swapimg.cl
#  HONIR bias subtraction
#
#           Ver 1.00 2011. 8.10 H.Akitaya
#           Ver 1.01 2011.10.21 H.Akitaya
#                       for abnormal image
#
#  input : file(s) or @list-file
#

procedure hnbtrim_virgo4swaping ( in_images )
...
begin
     ...
     while( fscan( imglist, img ) != EOF ){
        ...
        tmp_region1 = mktemp ( "_hntrim_virgo_tmp1" )
        tmp_region2 = mktemp ( "_hntrim_virgo_tmp2" )
        tmp_region3 = mktemp ( "_hntrim_virgo_tmp3" )
        tmp_region4 = mktemp ( "_hntrim_virgo_tmp4" )
	...
	imcopy( fn_in//region1, tmp_region4, ver- )
	imcopy( fn_in//region2, tmp_region1, ver- )
	imcopy( fn_in//region3, tmp_region2, ver- )
	imcopy( fn_in//region4, tmp_region3, ver- )
